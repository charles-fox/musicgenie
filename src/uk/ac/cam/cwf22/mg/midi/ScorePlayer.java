...
public class ScorePlayer {
	...
	public void saveMIDI(Score score, String fileName, String directory) throws InvalidMidiDataException, MidiUnavailableException, IOException
	{
	...
	//must call this to close MIDI system so others can use MIDI afterwards
	public void close() {
		sequencer.close();
	}
